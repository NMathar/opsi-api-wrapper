...
class OPSIApi {
	 ...
	 * @returns {Object} Data.
	 */
	getOpsiVersion(callback: (data: any) => void) {
	 ...
	 * @returns {Object} Data.
	 */
	actionsForProduct(productid:string, serverid:number, callback) {
	 ...
	 */
	createClient(clientName:string, domain:string = '', description:string = '', notes:string = '', ipAddress:string = '', hardwareAddress:string = '', callback) {
	 ...
	 * @private
	 */
	private sendRequest(method:string, params:any[], id:number, callback: (data: any) => void) {
